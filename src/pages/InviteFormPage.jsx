    ...
    return (
      <div className="min-h-screen bg-gradient-to-b from-indigo-50 to-gray-50 flex items-center justify-center p-4">
        <div className="bg-white rounded-2xl p-6 shadow-sm border border-red-200 max-w-md w-full text-center">
          {/* Icône d'avertissement SVG classique */}
          ...
          <form onSubmit={onSubmit} className="p-6 space-y-4">
            ...
            {error && (
              <div className="p-3 bg-red-50 text-red-700 rounded-lg border border-red-200 flex items-start">
                {/* Icône d'erreur SVG classique */}
                <svg className="h-5 w-5 mr-2 mt-0.5 flex-shrink-0 text-red-600" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M12 8v4m0 4h.01m-6.938 4h13.856c1.54 0 2.502-1.667 1.732-3L13.732 4c-.77-1.333-2.694-1.333-3.464 0L3.34 16c-.77 1.333.192 3 1.732 3z"></path>
                </svg>
